...
const translations = {
    es: {
        ...
        'slide2-badge': 'Agricultura e Industria',
        'slide2-h1': 'Soluciones para el<br>Agro y la Alta<br><span class="highlight-text">Industria</span>',
        'slide2-p': 'Componentes de alta precisión para maquinaria agrícola, equipos pesados y procesos industriales de alto rendimiento.',
        ...
        'slide5-badge': 'Transporte de Fluidos',
        'slide5-h1': 'Infraestructura Industrial<br>de la más alta<br><span class="highlight-text">Calidad</span>',
        'slide5-p': 'Tuberías, mangueras y sistemas completos para el manejo seguro y eficiente de recursos líquidos y gaseosos.',
        'slide5-btn1': 'Ver Catálogo',
        ...
        // Brand details
        'desc-amsted-rail': 'Componentes ferroviarios especializados.',
        'desc-creanza': 'Transmisión de potencia especializada.',
        'desc-donmez': 'Sistemas de suspensión y dirección.',
        'desc-fss': 'Soluciones de sistemas especializados.',
        'desc-gates': 'Transmisión de potencia y correas.',
        'desc-gedore': 'Herramientas profesionales de precisión.',
        'desc-hose': 'Mangueras industriales de fluidos.',
        'desc-kettenwulf': 'Cadenas industriales de transmisión.',
        'desc-kit-masters': 'Ventiladores y enfriamiento de motores.',
        'desc-miner': 'Materiales elastómeros industriales.',
        'desc-mwe': 'Soluciones de potencia especializadas.',
        'desc-prestone': 'Refrigerantes y fluidos automotrices.',
        'desc-ramsey': 'Sistemas de tracción y control.',
        'desc-reliable': 'Soluciones de confiabilidad industrial.',
        'desc-spectroline': 'Detección de fugas e inspección.',
        'desc-starrett': 'Herramientas de medición y metrología.',
    ...
    en: {
        ...
        'slide2-badge': 'Agriculture & Industry',
        'slide2-h1': 'Solutions for<br>Agriculture and High<br><span class="highlight-text">Industry</span>',
        'slide2-p': 'High-precision components for agricultural machinery, heavy equipment and high-performance industrial processes.',
        ...
        'slide5-badge': 'Fluid Transport',
        'slide5-h1': 'Industrial Infrastructure<br>of the Highest<br><span class="highlight-text">Quality</span>',
        'slide5-p': 'Pipes, hoses and complete systems for the safe and efficient handling of liquid and gaseous resources.',
        'slide5-btn1': 'View Catalog',
        ...
        // Brand details
        'desc-amsted-rail': 'Specialized railway components.',
        'desc-creanza': 'Specialized power transmission.',
        'desc-donmez': 'Suspension and steering systems.',
        'desc-fss': 'Specialized system solutions.',
        'desc-gates': 'Power transmission and belts.',
        'desc-gedore': 'Professional precision tools.',
        'desc-hose': 'Industrial fluid hoses.',
        'desc-kettenwulf': 'Industrial transmission chains.',
        'desc-kit-masters': 'Fans and motor cooling.',
        'desc-miner': 'Industrial elastomer materials.',
        'desc-mwe': 'Specialized power solutions.',
        'desc-prestone': 'Coolants and automotive fluids.',
        'desc-ramsey': 'Traction and control systems.',
        'desc-reliable': 'Industrial reliability solutions.',
        'desc-spectroline': 'Leak detection and inspection.',
        'desc-starrett': 'Measurement and metrology tools.',
