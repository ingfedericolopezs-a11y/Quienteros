...
const translations = {
    es: {
        ...
        'slide6-badge': 'Herramientas y Metrología',
        'slide6-h1': 'Precisión Profesional<br>en cada Medición y<br><span class="highlight-text">Ensamble</span>',
        'slide6-p': 'Gedore y Starrett: herramientas manuales alemanas, instrumentos de medición de alta precisión y soluciones de metrología para taller industrial y control de calidad.',
        'slide6-btn1': 'Ver Gedore',
        'slide6-btn2': 'Ver Starrett',
        'slide7-badge': 'Acabados Arquitectónicos',
        'slide7-h1': 'Porcelanato Vitrificado<br>de Gran Formato para<br><span class="highlight-text">Arquitectura</span>',
        'slide7-p': 'Creanza Tiles: fabricante indio líder en porcelanato GVT/PGVT con tecnología Sacmi, para proyectos residenciales, comerciales e institucionales de alto valor estético.',
        'slide7-btn1': 'Ver Creanza Tiles',
        ...
        'desc-zec': 'Mangueras y tuberías termoplásticas italianas.',
    ...
    en: {
        ...
        'slide6-badge': 'Tools & Metrology',
        'slide6-h1': 'Professional Precision<br>in every Measurement<br>and <span class="highlight-text">Assembly</span>',
        'slide6-p': 'Gedore and Starrett: German hand tools, high-precision measurement instruments and metrology solutions for industrial workshops and quality control.',
        'slide6-btn1': 'View Gedore',
        'slide6-btn2': 'View Starrett',
        'slide7-badge': 'Architectural Finishes',
        'slide7-h1': 'Large-Format<br>Vitrified Tiles for<br><span class="highlight-text">Architecture</span>',
        'slide7-p': 'Creanza Tiles: leading Indian manufacturer of GVT/PGVT vitrified porcelain with Sacmi technology, for residential, commercial and institutional projects of high aesthetic value.',
        'slide7-btn1': 'View Creanza Tiles',
