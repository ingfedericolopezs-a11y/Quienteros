...
const translations = {
    es: {
        ...
        'slide7-badge': 'Línea Arquitectónica',
        'slide7-h1': 'Porcelanato y Grifería<br>Premium para tus<br><span class="highlight-text">Espacios</span>',
        'slide7-p': 'Creanza Tiles (porcelanato vitrificado GVT/PGVT) + grifería de alta gama. Soluciones integrales para baños, cocinas y proyectos arquitectónicos residenciales, comerciales e institucionales.',
    ...
    en: {
        ...
        'slide7-badge': 'Architectural Line',
        'slide7-h1': 'Premium Porcelain<br>and Faucets for<br><span class="highlight-text">your Spaces</span>',
        'slide7-p': 'Creanza Tiles (GVT/PGVT vitrified porcelain) + premium faucets. Complete solutions for bathrooms, kitchens and architectural projects — residential, commercial and institutional.',
